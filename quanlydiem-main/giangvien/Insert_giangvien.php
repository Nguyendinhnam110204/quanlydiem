...
<body>
    ...
    <section class="dashboard">
        ...
        <form action="them_giangvien.php" method="post">
            <div class="form-group">
                <label for="">Mã giảng viên</label>
                <input type="text" id="MaGiangVien" name="MaGiangVien" class="form-control" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select id="TrinhDoHV" name="TrinhDoHV" class="form-control">
